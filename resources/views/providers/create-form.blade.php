    ...
    <div class="card-body">
        <form action="{{ route('providers.create') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control bg-secondary text-white border-dark @error('url') is-invalid @enderror" id="url" name="url" value="{{ old('url') }}" placeholder="https://www.example.com">
